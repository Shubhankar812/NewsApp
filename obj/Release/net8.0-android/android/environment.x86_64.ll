...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 317757319211359328, ; hash 0x468e699285f9c60, from name: aot-NewsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 10
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2112422245592701323, ; hash 0x1d50d4d71c2f998b, from name: aot-NewsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 60
	...
	%struct.DSOCacheEntry {
		i64 5517031288804727953, ; hash 0x4c906eba07ebdc91, from name: NewsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 165
	...
	%struct.DSOCacheEntry {
		i64 6518650893692704319, ; hash 0x5a76e6735556163f, from name: NewsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	...
	%struct.DSOCacheEntry {
		i64 8914681518164732979, ; hash 0x7bb74f9bd7f2ec33, from name: libaot-NewsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 9793305448886724739, ; hash 0x87e8cf6b29ca6883, from name: libaot-NewsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 303
...
@.env.3 = private unnamed_addr constant [37 x i8] c"963a52b9-ae97-4783-b34b-18638a49b992\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-NewsApp.dll.so\00", align 16
