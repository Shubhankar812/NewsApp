...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1249750075, ; hash 0x4a7dac3b, from name: aot-NewsApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2250036415, ; hash 0x861cd4bf, from name: libaot-NewsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 312
	...
	%struct.DSOCacheEntry {
		i64 2644864125, ; hash 0x9da56c7d, from name: NewsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 369
	...
	%struct.DSOCacheEntry {
		i64 3238017090, ; hash 0xc1003842, from name: libaot-NewsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
	...
	%struct.DSOCacheEntry {
		i64 3274538948, ; hash 0xc32d7fc4, from name: NewsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 460
	...
	%struct.DSOCacheEntry {
		i64 3675280105, ; hash 0xdb1052e9, from name: aot-NewsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-NewsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 504
